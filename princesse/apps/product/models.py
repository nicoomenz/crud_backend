...
class CustomProduct(models.Model):
    payment = models.ForeignKey(
        'payment.Payment',  # Apunta al modelo Payment
        on_delete=models.CASCADE,  # Elimina el CustomProduct si se elimina el Payment
        related_name='custom_products',  # Relación inversa desde Payment
        null=True,  # Permite que un CustomProduct no esté asociado a un Payment inicialmente
        blank=True
    )
